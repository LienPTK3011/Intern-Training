...
//create array list and read data from conferenceroom_info to the array list
...
public class IoRoom {
	public static boolean saveFile(ArrayList<ConferenceRoom> listRoom, String path) {
		try {
			...
			//data in conferenceroom_info.txt splited by ; to read and add to listRoom
	...
	//save data input to listRoom and save to conferenceroom_info.txt
