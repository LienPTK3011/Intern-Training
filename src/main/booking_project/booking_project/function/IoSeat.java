...
public class IoSeat {
	//create array list and read data from seat_information.txt to the array list
	public static boolean saveFile(ArrayList<Seat> listSeat, String path) {
		try {
			FileOutputStream fos = new FileOutputStream(path);
			OutputStreamWriter osw = new OutputStreamWriter(fos);
			BufferedWriter bw = new BufferedWriter(osw);
			//data in seat_information.txt splited by ; to read and add to listSeat
	...
	//save data input to listUser and save to seat_information.txt
