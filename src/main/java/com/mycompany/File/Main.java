...
public class Main {
	...
	private static void docFile() {
		csdl = Fileio.readFile("E://Java//Training//Intern-Training//src//main//java//com//mycompany//File//data//csdl_contact.dat");
	}

	private static void luuFile() {
		Fileio.saveFile(csdl, "E://Java//Training//Intern-Training//src//main//java//com//mycompany//File//data//csdl_contact.dat");
	}
